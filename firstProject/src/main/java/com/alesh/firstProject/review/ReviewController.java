...
public class ReviewController {
    ...
    public ResponseEntity<String> updateReview(@PathVariable Long companyId,
                                               @PathVariable Long reviewId,
                                               @RequestBody Review review){
        boolean isReviewUpdated = reviewService.updateReview(companyId, reviewId,
                review);
        if(isReviewUpdated)
            return  new ResponseEntity<>("Review updated successully",
                HttpStatus.OK);
        else
    ...
    public ResponseEntity<String> deleteReview (@PathVariable Long companyId,
        ...
        if(isReviewDeleted)
            return  new ResponseEntity<>("Review deleted successully",
                    HttpStatus.OK);
        else
